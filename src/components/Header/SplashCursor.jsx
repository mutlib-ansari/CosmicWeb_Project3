...
// const ClickSpark = ({ sparkColor = '#fff', sparkSize = 10, sparkRadius = 15, sparkCount = 8, duration = 400 }) => {
...
//                 spark.style.transform = `translate(${Math.random() * sparkRadius - sparkRadius / 2}px, ${Math.random() * sparkRadius - sparkRadius / 2}px)`;
//                 spark.style.transition = `opacity ${duration}ms ease, transform ${duration}ms ease`;
